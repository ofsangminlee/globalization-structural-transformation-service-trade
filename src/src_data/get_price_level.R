...
list.sub <- list(c("AtB", "C", "D", "E"), c("F", "H", "70", "LtP"), c("G", "I", "J", "71t74"))
...
list.sub.alt <- list(c("AtB", "C", "D", "E"), c("F", "70", "LtP"), c("G", "I", "H", "J", "71t74"))
...
writeLines(paste("ROW share of the world total GDP is", gdp.2018$gdp[gdp.2018$country == "ROW"]/sum(gdp.2018$gdp)), "../../doc/nums/row_share_gdp.txt")
