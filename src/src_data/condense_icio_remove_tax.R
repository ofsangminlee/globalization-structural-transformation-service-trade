...
icio.years <- lapply(icio.years.orig, function(x) condense.icio(x, list.re, list.ind, "g.cs.ps"))
icio.years.alt <- lapply(icio.years.orig, function(x) condense.icio(x, list.re.alt, list.ind.alt, "g.bts.hts"))
