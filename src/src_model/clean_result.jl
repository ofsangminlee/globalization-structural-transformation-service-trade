...
str_chg_cs = get_result(res_cs, res_cs_no, list_inds)
...
for i_model in ["str_chg", "str_chg_hs", "str_chg_no_s_trade", "str_chg_gs", "str_chg_alt", "str_chg_low", "str_chg_high", "str_chg_wedge", "str_chg_nest", "str_chg_nx", "str_chg_cs", "str_chg_orig"]
